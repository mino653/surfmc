...
class EmailService {
    ...
    initializeTemplates() {
        return {
            login: {
                subject: '🎮 Login Alert - MineCraft Server',
                template: `
                    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #f8f9fa; padding: 20px;">
                        <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
                            <h1 style="color: white; margin: 0; font-size: 24px;">🎮 MineCraft Server</h1>
                        ...
                        <div style="background: white; padding: 30px; border-radius: 0 0 10px 10px; box-shadow: 0 5px 15px rgba(0,0,0,0.1);">
                            ...
                            <p style="color: #666; line-height: 1.6; margin-bottom: 20px;">
                                We noticed you just logged into your MineCraft Server account. Here are the details:
                            </p>
                            ...
                            <p style="color: #999; font-size: 14px; text-align: center;">
                                This is an automated security notification from MineCraft Server.<br>
            ...
            welcome: {
                subject: '🎉 Welcome to MineCraft Server!',
                template: `
                    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #f8f9fa; padding: 20px;">
                        <div style="background: linear-gradient(135deg, #667eea 0%, #764ba2 100%); padding: 30px; text-align: center; border-radius: 10px 10px 0 0;">
                            <h1 style="color: white; margin: 0; font-size: 24px;">🎮 MineCraft Server</h1>
                        ...
                        <div style="background: white; padding: 30px; border-radius: 0 0 10px 10px; box-shadow: 0 5px 15px rgba(0,0,0,0.1);">
                            ...
                            <p style="color: #666; line-height: 1.6; margin-bottom: 20px;">
                                Thank you for joining our MineCraft Server community! Your account has been successfully created and you're ready to start your adventure.
                            </p>
            ...
            purchase: {
                subject: '🛒 Purchase Confirmation - MineCraft Server',
                template: `
                    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #f8f9fa; padding: 20px;">
            ...
            passwordChange: {
                subject: '🔐 Password Changed - MineCraft Server',
                template: `
                    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background: #f8f9fa; padding: 20px;">
